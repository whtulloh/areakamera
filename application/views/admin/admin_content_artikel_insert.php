                        ...
                        <div class="row-fluid">                            
                            <div class="box span12">
                                ...
                                <div class="box-content">     
                                    <form class="form-horizontal" action="<?php echo base_url();?>admin/artikel_insert_olah" method="post">
                                        <fieldset>     
                                                ...
                                                <div class="controls">
                                                    <textarea name="konten">
                                                        ...
                                                        if (isset($error)) {
                                                            ...
                                                            echo "gunakan tombol paste from word diatas untuk hasil yang terbaik";
                                                        }
                                                        ?>
                                                    </textarea>   
                                                </div>
