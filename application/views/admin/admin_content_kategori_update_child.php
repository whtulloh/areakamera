                        ...
                        <div class="row-fluid">                            
                            <div class="box span12">
                                ...
                                <div class="box-content">     
                                    <form class="form-horizontal" action="<?php echo base_url();?>admin/kategori_update_child_olah" method="post">
                                        <fieldset>     
                                                ...
                                                <div class="controls">
                                                    <select id="selectError" data-rel="chosen" name="namakategoriparent">
                                                        ...
                                                        foreach ($kategori_parent as $row) {
                                                            if($row->category_id == $kategori_child->parent_id) {
                                                            ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="input-xlarge" name="namakategorichild" value="<?php echo $kategori_child->name; ?>">
                                                </div>
                                            </div>                                                                              
                                            
                                            <input type="hidden" name="idkategorichild" value="<?php echo $kategori_child->category_id; ?>">
