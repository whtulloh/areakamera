<div class="container">
    ...
    <div class="row">
        ...
        <div class="span7 popular_products">
			...
			// potong name //
			$potong = character_limiter($rows->name, 50);
                        ?>
                        <li class="span2" style="float: left;">
                            <div class="thumbnail" style="height: 200px;">
                                <center><a href="<?php echo base_url(); ?>home/item/<?php echo $rows->item_id; ?>">
								<img style="height: 100px; max-height: 150px;" title="<?php echo $rows->name; ?>" src="<?php echo base_url(); ?>res/image/<?php echo $rows->picture_path_resize; ?>">
								</a></center>
                                <div class="caption">                                    
