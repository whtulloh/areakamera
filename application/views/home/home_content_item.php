        ...
        <div class="span9">
            ...
            <div class="row">
                <div class="span9">
					...
					// potong name //
					$potong = character_limiter($rows_related->name, 70);
                                        ?>
                                        <li class="span2">
                                            <div class="thumbnail" style="height: 220px;">
                                                <a href="<?php echo base_url(); ?>home/item/<?php echo $rows_related->item_id; ?>"><img style="height: 100px; max-height: 150px;" title="<?php echo $rows_related->name; ?>" src="<?php echo base_url();?>res/image/<?php echo $rows_related->picture_path; ?>"></a>
                                                <div class="caption">
                                                    <a href="<?php echo base_url(); ?>home/item/<?php echo $rows_related->item_id; ?>""> <h5><?php echo $potong;?></h5></a>  Price: <?php echo $rows_related->price; ?><br><br>
                                                </div>
                                            </div>
                                        </li>                                    
                                        <?php
